		...
		<form action="Register" method="get">
			...
			<div class="container">
				<label for="uname"><b>Name</b></label><br> <input type="text"
					name="fn" placeholder="Enter Your Name" pattern="[A-Za-z]{3,}"
					required><br> <label for="email"><b>Gmail</b></label><br>
				...
				<br> <select class="form-select" name="department"
					aria-label="Default select example">
					<option selected disable>Enter Your Department</option>
				...
				<br> <label for="psw"><b> Password</b></label><br> <input
					...
					title="must be provide 6 characters and use some special characters for safty purpose"
					required><br>
