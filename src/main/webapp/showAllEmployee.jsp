...
<body>
	...
	<form action="employee" method="get">
		...
		<div class="btn1">
			<a href="adminUpdateEmployee.jsp"><button type="button"
					class="btn btn-secondary">Update Employee</button></a>
		</div>
		<div class="btn2">
			<a href="requestForm.jsp"><button type="button"
				...
				<c:forEach items="${employee}" var="show">
					...
					<tbody>
						...
						<tr>
							<td>${show.empId}</td>
							<td>${show.empName}</td>
							<td>${show.empDepartment}</td>
							<td>${show.empEmail}</td>
							<td>${show.empPassword}</td>
							<td>${show.usersType}</td>
